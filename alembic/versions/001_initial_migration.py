...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('created_by', sa.String(length=50), nullable=True, comment='User ID who created this record'),
        sa.Column('updated_by', sa.String(length=50), nullable=True, comment='User ID who last updated this record'),
    ...
    op.create_table(
        ...
        sa.Column('created_by', sa.String(length=50), nullable=True, comment='User ID who created this record'),
        sa.Column('updated_by', sa.String(length=50), nullable=True, comment='User ID who last updated this record'),
        sa.Column('user_id', sa.String(length=50), nullable=False, comment='Reference to user'),
        sa.Column('role_id', sa.String(length=50), nullable=False, comment='Reference to role'),
        sa.Column('assigned_by', sa.String(length=50), nullable=True, comment='ID of user who assigned this role'),
    ...
    op.create_table(
        ...
        sa.Column('created_by', sa.String(length=50), nullable=True, comment='User ID who created this record'),
        sa.Column('updated_by', sa.String(length=50), nullable=True, comment='User ID who last updated this record'),
        sa.Column('from_currency_id', sa.String(length=50), nullable=False, comment='Source currency ID'),
        sa.Column('to_currency_id', sa.String(length=50), nullable=False, comment='Target currency ID'),
        ...
        sa.Column('approved_by', sa.String(length=50), nullable=True, comment='User ID who approved this rate'),
