# =============== alembic/env.py ===============
"""
Alembic environment configuration for CEMS database migrations.
"""
...
def run_migrations_offline() -> None:
    ...
    context.configure(
        ...
        # Include schema in table names for PostgreSQL
        include_schemas=True,
        # Compare type for better column type detection
        compare_type=True,
        # Compare server defaults
        compare_server_default=True,
        # Render schema for foreign keys
...
def run_migrations_online() -> None:
    ...
    with connectable.connect() as connection:
        context.configure(
            ...
            # Render schema for foreign keys
            render_as_batch=False,
            # Transaction per migration for PostgreSQL
